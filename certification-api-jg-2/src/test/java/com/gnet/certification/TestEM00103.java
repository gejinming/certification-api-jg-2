...
public class TestEM00103 extends CertificationAddBeforeJUnit {
	...
	public void testExecute() {
		Long majorId = 165008L;
		Long parentId = 165009L;
		String no = "thisIsNu";
		...
		data.put("pass", pass);
		HttpResponse httpResponse = super.api("EM00103", token, data).send();
