...
[#assign TEXT = 1, NUMBER = 2, TOTAL = 3, INDICATION = 4,INDICTIONPORT=5]
                ...
                <w:body>
                    ...
                    <w:p w:rsidR="002364E3" w:rsidRPr="00866D64" w:rsidRDefault="002364E3" w:rsidP="002364E3">
                        ...
                        <w:r w:rsidR="00567F40" w:rsidRPr="00567F40">
                            ...
                            <w:t>
                                [#if couresInfo.content??]${couresInfo.content}[/#if]/[#if data.courseInfos??][#list data.courseInfos as couresInfo][#if "学时" == couresInfo.name && couresInfo.content??]${couresInfo.content}[/#if][/#list][/#if] （[#if data.theoryHours?? && data.theoryHours>0]理论：${data.theoryHours}[/#if][#if data.theoryHours?? && data.theoryHours>0 && (data.experimentHours?? && data.experimentHours>0) || (data.practiceHours?? && data.practiceHours>0) || (data.dicussHours?? && data.dicussHours>0) || (data.exercisesHours?? && data.exercisesHours>0)]，[/#if][#if data.experimentHours?? && data.experimentHours>0]实验：${data.experimentHours}[#elseif data.practiceHours?? && data.practiceHours>0]实践：${data.practiceHours}[/#if][#if ((data.theoryHours?? && data.theoryHours>0) || (data.experimentHours?? && data.experimentHours>0) || (data.practiceHours?? && data.practiceHours>0)) && ((data.dicussHours?? && data.dicussHours>0) || (data.exercisesHours?? && data.exercisesHours>0))]，[/#if][#if data.dicussHours?? && data.dicussHours>0]研讨：${data.dicussHours}[/#if][#if ((data.theoryHours?? && data.theoryHours>0) || (data.experimentHours?? && data.experimentHours>0) || (data.practiceHours?? && data.practiceHours>0) || (data.dicussHours?? && data.dicussHours>0)) && (data.exercisesHours?? && data.exercisesHours>0)]，[/#if][#if data.exercisesHours?? && data.exercisesHours>0]习题：${data.exercisesHours}[/#if]）
                            </w:t>
                        </w:r>
                            ...
                            <w:tc>
                                ...
                                <w:p w:rsidR="00CA327E" w:rsidRPr="008D4C72" w:rsidRDefault="00CA327E" w:rsidP="00B770D0">
                                    ...
                                    <w:r w:rsidRPr="008D4C72">
                                        ...
                                        <w:t>[#if data.auditorName??]审核人：[/#if]</w:t>
                                    </w:r>
                                </w:p>
                            </w:tc>
                            <w:tc>
                                ...
                                <w:p w:rsidR="00CA327E" w:rsidRPr="008D4C72" w:rsidRDefault="00CA327E" w:rsidP="00B770D0">
                                    ...
                                    <w:r w:rsidRPr="003219BF">
                                        ...
                                        <w:t>[#if data.auditorName??]${data.auditorName}[/#if]</w:t>
                                    </w:r>
                                    <w:r>
                                        <w:rPr>
                                            <w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman" w:cs="Times New Roman" w:hint="eastAsia"/>
                            ...
                            <w:tc>
                                ...
                                <w:p w:rsidR="00CA327E" w:rsidRPr="008D4C72" w:rsidRDefault="00CA327E" w:rsidP="00B770D0">
                                    ...
                                    <w:r w:rsidRPr="008D4C72">
                                        ...
                                        <w:t>[#if data.authorName??]执笔人 ：[/#if]</w:t>
                                    </w:r>
                                </w:p>
                            </w:tc>
                            <w:tc>
                                ...
                                <w:p w:rsidR="00CA327E" w:rsidRPr="003219BF" w:rsidRDefault="00CA327E" w:rsidP="00B770D0">
                                    ...
                                    <w:r>
                                        ...
                                        <w:t>[#if data.authorName??]${data.authorName}[/#if]</w:t>
                                    </w:r>
                                </w:p>
                            </w:tc>
                            <w:tc>
                    ...
                    <w:p w:rsidR="003B55EB" w:rsidRPr="00393F8F" w:rsidRDefault="003B55EB" w:rsidP="003B55EB">
                        <w:pPr>
                            <w:adjustRightInd w:val="0"/>
                    ...
                    <w:p w:rsidR="00CF1355" w:rsidRPr="00F96D02" w:rsidRDefault="00CF1355" w:rsidP="00CF1355">
                        ...
                        <w:r>
                            ...
                            <w:t>${module.mainContent}</w:t>
                        </w:r>            
                    </w:p>
                    [/#if]
                    [#if module_index == 0]
                    <w:p w:rsidR="00635407" w:rsidRDefault="00635407" w:rsidP="003219BF">
                        <w:pPr>
                            <w:ind w:firstLineChars="200" w:firstLine="420"/>
                            <w:rPr>
                    ...
                    <w:p w:rsidR="00CF1355" w:rsidRDefault="00CF1355" w:rsidP="00CF1355">
                        ...
                        <w:r>
                            ...
                            <w:t>本课程重点支持以下毕业要求指标点：</w:t>
                        </w:r>
                    </w:p>
                    <!-- 课程支持指标点列表 -->
                    [#if module.indications??]
                    [#list module.indications as indication]
                    [#if indication.graduateIndexNum?? && indication.indicationIndexNum?? && indication.indicationContent??]
                    <w:p w:rsidR="00CF1355" w:rsidRDefault="001B7FD6" w:rsidP="001B7FD6">
                        <w:pPr>
                            <w:ind w:firstLineChars="200" w:firstLine="422"/>
                            <w:rPr>
                                <w:rFonts w:hint="eastAsia"/>
                        ...
                        <w:r w:rsidRPr="001B7FD6">
                            <w:rPr>
                                <w:rFonts w:hint="eastAsia"/>
                                <w:b/>
                                <w:szCs w:val="22"/>
                            </w:rPr>
                            <w:t>${indication.graduateIndexNum}.${indication.indicationIndexNum}：${indication.indicationContent}</w:t>
                        </w:r>                   
                    </w:p>
                    [/#if]
                    [#if indication.remark??]
                    <w:p w:rsidR="00CF1355" w:rsidRDefault="00CF1355" w:rsidP="00CF1355">
                        <w:pPr>
                            <w:pStyle w:val="a3"/>
                    ...
                    <w:p w:rsidR="00CF1355" w:rsidRDefault="00CF1355" w:rsidP="00CF1355">
                        ...
                        <w:r w:rsidRPr="00ED60A9">
                            <w:rPr>
                                <w:rFonts w:hint="eastAsia"/>
                            </w:rPr>
                            <w:t>${teachingContent.basicRequirement}</w:t>
                        </w:r>
                    </w:p>
                    [/#if]
                    [#if teachingContent.indications?? && teachingContent.indications?size>0]
                    <w:p w:rsidR="00CF1355" w:rsidRDefault="00CF1355" w:rsidP="00CF1355">
                        <w:pPr>
                            <w:tabs>
                        ...
                        <w:t>重点支持毕业要求指标点[#list teachingContent.indications as indication][#if indication.graduateIndexNum?? && indication.indicationIndexNum??]${indication.graduateIndexNum}.${indication.indicationIndexNum}[#if (indication_index + 1) != teachingContent.indications?size ]、[/#if][/#if][/#list]。</w:t>
                        </w:r>
                    </w:p>
                    [/#if]
                    [/#list]
                    ...
                    <w:p w:rsidR="00CA327E" w:rsidRDefault="00CA327E" w:rsidP="00CA327E">
                        ...
                        <w:r>
                            ...
                            <w:t>${secondaryContent.content}</w:t>
                        </w:r>
                    </w:p>
                    [/#if]
                    [#if secondaryContent.indications?? && secondaryContent.indications?size>0]
                    <w:p w:rsidR="00CA327E" w:rsidRDefault="00CA327E" w:rsidP="00CA327E">
                        <w:pPr>
                            <w:pStyle w:val="a5"/>
                        ...
                        <w:r w:rsidRPr="00541439">
                            ...
                            <w:t>重点支持毕业要求指标点[#list secondaryContent.indications as indication][#if indication.graduateIndexNum?? && indication.indicationIndexNum??]${indication.graduateIndexNum}.${indication.indicationIndexNum}[#if (indication_index + 1) != secondaryContent.indications?size ]、[/#if][/#if][/#list]。</w:t>
                        </w:r>
                    </w:p>
                    [/#if]
                    [/#list]
                            ...
                            <w:tc>
                                ...
                                <w:p w:rsidR="00CF1355" w:rsidRPr="005821DE" w:rsidRDefault="00CF1355" w:rsidP="0073036F">
                                    ...
                                    <w:r w:rsidRPr="005821DE">
                                        ...
                                        <w:t>
                                            [#if tableDetail.type == 4]
                                                [#if tableDetail.indications?? && tableDetail.indications?size>0]
                                                    指标点：[#list tableDetail.indications as indication][#if indication.graduateIndexNum?? && indication.indicationIndexNum??]${indication.graduateIndexNum}.${indication.indicationIndexNum}[#if (indication_index + 1) != tableDetail.indications?size ]、[/#if][/#if][/#list]
                                                [/#if]
                                            [#else]
                            ...
                            <w:tc>
                                ...
                                <w:p w:rsidR="00CF1355" w:rsidRPr="005821DE" w:rsidRDefault="00CF1355" w:rsidP="0073036F">
                                    ...
                                    <w:r w:rsidRPr="005821DE">
                                        ...
                                        <w:t>
                                        [#if header?? && header.type == NUMBER && header.hours??]
                                            ${header.hours}
                                        [#else]
                    ...
                    [/#if]
                    [/#list]
                    <w:p w:rsidR="00790A75" w:rsidRPr="00790A75" w:rsidRDefault="00790A75" w:rsidP="00790A75">
                        <w:pPr>
                            <w:rPr>
                                <w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman" w:cs="Times New Roman" w:hint="eastAsia"/>
                                <w:b/>
                    ...
                    [/#if]
                    <w:p w:rsidR="00CA327E" w:rsidRPr="00F96D02" w:rsidRDefault="00CA327E" w:rsidP="00CF1355">
                        <w:pPr>
                            <w:ind w:firstLineChars="200" w:firstLine="420"/>
                            <w:rPr>
                                <w:rFonts w:hint="eastAsia"/>
                    ...
                    <w:p w:rsidR="00CA327E" w:rsidRPr="00CF1355" w:rsidRDefault="00CA327E" w:rsidP="002B3A0D">
                        <w:pPr>
                            <w:pStyle w:val="-"/>
                            <w:ind w:firstLine="0"/>
                            <w:jc w:val="center"/>
