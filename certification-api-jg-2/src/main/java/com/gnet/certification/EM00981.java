...
public class EM00981 extends BaseApi implements IApi {
	...
	public Response excute(Request request, Response response, ResponseHeader header, String method) {
        ...
        try {
			...
			ccCourseGradecomposeDetailService.validateImportSubjectScore(subjectMap, studentIds, detailIds, addList, editList, subjects, eduClassId, courseGradeComposeId, studentList, ccEduclass, subjectScoreMap);
