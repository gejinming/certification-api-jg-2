...
@Service("EM00382")
public class EM00382 extends BaseApi implements IApi {
	...
	public Response excute(Request request, Response response, ResponseHeader header, String method) {
		...
		Page<CcStudent> page = CcStudent.dao.page(pageable, classId, name, studentNo);
		...
		for (CcStudent ccStudent : studentList) {
			...
			object.put("classStudentId", ccStudent.getLong("classStudentId"));
			...
			object.put("classId", ccStudent.getLong("classId"));
			object.put("className", ccStudent.getStr("className"));
			object.put("majorId", ccStudent.getLong("majorId"));
			object.put("majorName", ccStudent.getStr("majorName"));
			...
			object.put("isCaculate", ccStudent.getBoolean("isCaculate"));
			list.add(object);
		}
