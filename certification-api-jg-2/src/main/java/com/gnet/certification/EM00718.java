 ...
 */
@Service("EM00718")
public class EM00718 extends BaseApi implements IApi {
	...
	public Response excute(Request request, Response response, ResponseHeader header, String method) {
		...
		List<CcCourseOutline> ccCourseOutlineList =  CcCourseOutline.dao.findListByCourseId(courseId, null, user.getLong("id"), false);
