...
public class EM00972 extends BaseApi implements IApi {
	...
	public Response excute(Request request, Response response, ResponseHeader header, String method) {
		...
		if(!ccCourseGradecomposeDetailService.validateImportSubject(subjects, ccCourseGradeComposeDetails, courseGradeComposeId, indicationIdMap, ccCourseGradecomposeDetailIndications, ccIndications)){
