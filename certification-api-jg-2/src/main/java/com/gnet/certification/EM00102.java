 ...
 */
@Service("EM00102")
public class EM00102 extends BaseApi implements IApi {
	...
	public Response excute(Request request, Response response, ResponseHeader header, String method) {
		...
		String applyGrade = ccVersionService.getSaveApplyGrade(CcVersion.TYPE_MAJOR_VERSION, enableGrade, parentId);
		...
		// 找到最新的版本
		CcVersion lastCcVersion = ccVersionService.findLastVersion(majorId, null);
		majorVersion = lastCcVersion == null ? 1 : lastCcVersion.getInt("major_version") + 1;
