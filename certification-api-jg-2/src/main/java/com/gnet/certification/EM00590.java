 ...
 */
@Service("EM00590")
public class EM00590 extends BaseApi implements IApi {
	...
	public Response excute(Request request, Response response, ResponseHeader header, String method) {
		...
		List<CcTeacher> teachers = CcTeacher.dao.getDifferentJobTeacherNum(majorId);
		...
		for(CcTeacher temp: teachers){
		    ...
		    teacher.put("jobTitle", DictUtils.findLabelByTypeAndKey("statisticJobTitle", temp.getInt("jobTitle")));
