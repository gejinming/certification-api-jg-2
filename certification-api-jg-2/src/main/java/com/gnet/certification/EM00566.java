 ...
 * @author xzl
 * 
 * @date 2016年10月31日15:28:33
 *
 */
@Service("EM00566")
@Transactional(readOnly=false)
public class EM00566 extends BaseApi implements IApi{
	...
	public Response excute(Request request, Response response, ResponseHeader header, String method) {
		...
		if(ids.isEmpty()){
			return renderFAIL("0519", response, header);
		}
		...
		if(!CcScoreStuIndigrade.dao.deleteAll(idsArray, date)){
