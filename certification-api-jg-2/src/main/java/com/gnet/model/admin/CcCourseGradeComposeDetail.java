...
public class CcCourseGradeComposeDetail extends DbModel<CcCourseGradeComposeDetail> {
	 ...
	 * @return
	 */
	public Page<CcCourseGradeComposeDetail> page(Pageable pageable, String name, String detail, Long courseGradeComposeId) {
	 ...
	 * @return
	 */
	public Boolean isExisted(String name, String originValue, Long courseGradecomposeId){
	 ...
	 * @return
	 */
	public Boolean isExisted(String name, Long courseGradecomposeId) {
		return isExisted(name, null, courseGradecomposeId);
	}
