...
public class TestEM00116 extends CertificationAddBeforeJUnit {
	...
	public void testImportStudentExecute() {
		...
		HttpResponse httpResponse = super.api("EM00116", token, data).form("upfile", file).send();
