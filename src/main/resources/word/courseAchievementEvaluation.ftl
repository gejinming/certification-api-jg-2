                ...
                <w:body>
                            ...
                            <w:tc>
                                ...
                                <w:p w:rsidR="00AC0F3E" w:rsidRPr="003F630F" w:rsidRDefault="00ED74D0">
                                    ...
                                    <w:r w:rsidRPr="003F630F">
                                        ...
                                        <w:t>[#if data.achieveReportInfo.assessDocunment??]${data.achieveReportInfo.assessDocunment}[/#if]</w:t>
                                    </w:r>
                            ...
                            <w:tc>
                                ...
                                <w:p w:rsidR="00AC0F3E" w:rsidRPr="003F630F" w:rsidRDefault="00ED74D0">
                                    ...
                                    <w:r w:rsidRPr="003F630F">
                                        ...
                                        <w:t>一、达成度评价结果的分析</w:t>
                                    </w:r>

                                </w:p>
                                [#if data.achieveReportInfo.achieveResult??]
                                    [#--富文本--]
                                    [#if data.achieveReportInfo.achieveResult?is_string && data.achieveReportInfo.achieveResult?index_of("<w:") != -1 && data.achieveReportInfo.achieveResult?index_of("</w:") != -1]
                                        ${data.achieveReportInfo.achieveResult}
                                    [#else ]
                                    [#--下面就是是否有回车 有换行 自成一段--]
                                        [#assign mainContentMap = data.achieveReportInfo.achieveResult]
                                                                    ...
                                                                    [#if sentence?? && sentence.isNonChinese??]
                                                                        [#if sentence.isNonChinese == 1]
                                                                            <w:r>
                                                                                ...
                                                                                <w:t>[#if sentence.content??]${sentence.content}[/#if]
                                                                                </w:t>
                                                                            </w:r>
                                                                        [#else ]
                                                                            <w:r>
                                ...
                                <w:p w:rsidR="00AC0F3E" w:rsidRPr="003F630F" w:rsidRDefault="00AC0F3E">
                                    <w:pPr>
                                        <w:spacing w:line="300" w:lineRule="exact"/>
                                ...
                                [#if data.achieveReportInfo.courseModified??]
                                    [#--富文本--]
                                    [#if data.achieveReportInfo.courseModified?is_string && data.achieveReportInfo.courseModified?index_of("<w:") != -1 && data.achieveReportInfo.courseModified?index_of("</w:") != -1]
                                        ${data.achieveReportInfo.courseModified}
                                    [#else ]
                                    [#--下面就是是否有回车 有换行 自成一段--]
                                        [#assign mainContentMap = data.achieveReportInfo.courseModified]
                                        [#if mainContentMap?is_hash]
                                            [#if mainContentMap.isNonChinese == 0]
                                                <w:p w:rsidR="00146544" w:rsidRDefault="00527932">
                                                    <w:pPr>
                                ...
                                <w:p w:rsidR="00AC0F3E" w:rsidRPr="003F630F" w:rsidRDefault="00ED74D0">
                                    ...
                                    <w:r w:rsidRPr="003F630F">
                                        ...
                                        <w:t>三、拟采用的持续改进措施</w:t>
                                    </w:r>
                                </w:p>
                                [#if data.achieveReportInfo.courseImprovement??]
                                    [#--富文本--]
                                    [#if data.achieveReportInfo.courseImprovement?is_string && data.achieveReportInfo.courseImprovement?index_of("<w:") != -1 && data.achieveReportInfo.courseImprovement?index_of("</w:") != -1]
                                        ${data.achieveReportInfo.courseImprovement}
                                    [#else ]
                                    [#--下面就是是否有回车 有换行 自成一段--]
                                        [#assign mainContentMap = data.achieveReportInfo.courseImprovement]
                                        [#if mainContentMap?is_hash]
                                            [#if mainContentMap.isNonChinese == 0]
                                                <w:p w:rsidR="00146544" w:rsidRDefault="00527932">
                                                    <w:pPr>
                                                                    ...
                                                                    [#if sentence?? && sentence.isNonChinese??]
                                                                        [#if sentence.isNonChinese == 1]
                                                                            <w:r>
                                                                                ...
                                                                                <w:t>
                                                                                    [#if sentence.content??]${sentence.content}[/#if]
                                                                                </w:t>
                                                                            </w:r>
                                                                        [#else ]
                                                                            <w:r>
                    ...
                    <w:p w:rsidR="00AC0F3E" w:rsidRPr="003F630F" w:rsidRDefault="00ED74D0">
                        ...
                        <w:r w:rsidRPr="003F630F">
                            ...
                            <w:t>[#if data.achieveReportInfo.assessRequire??]${data.achieveReportInfo.assessRequire}[/#if]</w:t>
                        </w:r>
                    </w:p>
                    <w:p w:rsidR="00AC0F3E" w:rsidRPr="003F630F" w:rsidRDefault="00ED74D0">
                        <w:pPr>
                    ...
                    <w:p w:rsidR="00AC0F3E" w:rsidRPr="003F630F" w:rsidRDefault="00AC0F3E"/>
                    <w:sectPr w:rsidR="00AC0F3E" w:rsidRPr="003F630F">
                        <w:pgSz w:w="11906" w:h="16838"/>
                        <w:pgMar w:top="1077" w:right="1077" w:bottom="1077" w:left="1077" w:header="737" w:footer="624" w:gutter="0"/>
                        <w:cols w:space="425"/>
        ...
        <pkg:xmlData>
            <w:footnotes
                ...
                <w:footnote w:type="separator" w:id="-1">
                    <w:p w:rsidR="00ED74D0" w:rsidRDefault="00ED74D0" w:rsidP="003A6826">
                        <w:r>
                            <w:separator/>
                        </w:r>
                    </w:p>
        ...
        <pkg:xmlData>
            <w:settings
                ...
                <w:rsids>
                    ...
                    <w:rsid w:val="5B54634B"/>
                    <w:rsid w:val="712E0B87"/>
                </w:rsids>
                <m:mathPr>
                ...
                <w15:docId w15:val="{5511523F-BE36-4F96-9DB9-64AB9462DF7E}"/>
            </w:settings>
        </pkg:xmlData>
    </pkg:part>
    ...
    <pkg:part pkg:name="/docProps/core.xml" pkg:contentType="application/vnd.openxmlformats-package.core-properties+xml" pkg:padding="256">
        <pkg:xmlData>
            <cp:coreProperties
                ...
                <dcterms:created xsi:type="dcterms:W3CDTF">2020-08-18T06:49:00Z</dcterms:created>
                <dcterms:modified xsi:type="dcterms:W3CDTF">2020-08-18T06:49:00Z</dcterms:modified>
            </cp:coreProperties>
        </pkg:xmlData>
    </pkg:part>
    ...
    <pkg:part pkg:name="/docProps/app.xml" pkg:contentType="application/vnd.openxmlformats-officedocument.extended-properties+xml" pkg:padding="256">
        <pkg:xmlData>
            <Properties
                ...
                <Company>zust</Company>
                <LinksUpToDate>false</LinksUpToDate>
                <CharactersWithSpaces>1588</CharactersWithSpaces>
