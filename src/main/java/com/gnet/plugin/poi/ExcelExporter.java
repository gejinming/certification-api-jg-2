...
public class ExcelExporter {
     ...
     * @param tip                        提示
     */
    public static void exportToExcel(int depth, RowDefinition rowDefinition, ExcelExporterDataProcessor excelExporterDataProcessor, String targetFile, String tip,int state) {
        ...
        for (int i = 0; i <= sheet.getLastRowNum(); i++) {
            ...
            for (int j = 0; j < rowDefinition.getIndexs().size(); j++) {
                ...
                if (i == 0) {
                    ...
                    if (state==0){
                        //0第一列设置为文本格式
                        sheet.setDefaultColumnStyle(0,styles.get("celltext"));
                    }
        ...
        while (iter.hasNext()) {
            ...
            if (columnDefinition.getDataValidationDefinition() != null) {
                ...
                if (state==0){
                    ...
                    String indiconame = columnDefinition.getName();
                    String name = indiconame.substring(0, indiconame.indexOf(":"));
                    option[0]=name;
                    // 存在值约束
