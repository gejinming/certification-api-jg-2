 ...
 * 
 * @author SY
 * @Date 2019年12月9日13:37:49
 */
@Service("EM01104")
public class EM01104 extends BaseApi implements IApi {
	...
	public Response excute(Request request, Response response, ResponseHeader header, String method) {
		...
		// 判断是否还有课程表在使用
		List<CcCourse> ccCourses = CcCourse.dao.findFilteredByColumnIn("property_secondary_id", idsArray);
		...
		// 返回操作是否成功
		Boolean isSuccess = CcCoursePropertySecondary.dao.deleteAll(idsArray, date);
