...
@Service("EM00650")
public class EM00650 extends BaseApi implements IApi  {
	...
	public Response excute(Request request, Response response, ResponseHeader header, String method) {
		...
		final String key = grade.toString() + versionId.toString() + "异步统计个人达成度数据";
		// 找到最新创建的任务状态记录
		CcReportBuildStatus ccReportBuildStatus = CcReportBuildStatus.dao.getBuildStatusRecord(CcReportBuildStatus.TYPE_STUDENT, key);
		if (ccReportBuildStatus == null) {
			return renderFAIL("0529", response, header);
		}
