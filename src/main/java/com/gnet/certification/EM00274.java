...
public class EM00274 extends BaseApi implements IApi{
	...
	public Response excute(Request request, Response response, ResponseHeader header, String method) {
		...
		if(indicationIds.size()!=0){

			List<CcCourseTargetIndication> ccCourseTargetIndicationsCheck = CcCourseTargetIndication.dao.findByColumnIn("indication_id", indicationIds.toArray(new Long[indicationIds.size()]));
