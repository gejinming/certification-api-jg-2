...
public class EM00380 extends BaseApi implements IApi{

	/* (non-Javadoc)
	 * @see com.gnet.api.service.IApi#excute(com.gnet.api.Request, com.gnet.api.Response, com.gnet.api.ResponseHeader, java.lang.String)
	 */
	@Override
	public Response excute(Request request, Response response, ResponseHeader header, String method) {
		...
		List<CcTeacherCourse> existTeacherCourseClassStudent = CcTeacherCourse.dao.findExistCourseClassStudent(educlass.getLong("teacher_course_id"), studentIds.toArray(new Long[studentIds.size()]));
	    if(!existTeacherCourseClassStudent.isEmpty()){
	    	...
	    	return renderFAIL("0440", response, header, stringBuilder.append("已经存在该门开课课程中了").toString());
	    }
	    
	    List<CcEduclassStudent> newStudents  = Lists.newArrayList();
		for (Long studentId : studentIds) {
			IdGenerate idGenerate = com.gnet.utils.SpringContextHolder.getBean(IdGenerate.class);
