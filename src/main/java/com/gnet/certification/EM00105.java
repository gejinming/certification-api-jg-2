...
public class EM00105 extends BaseApi implements IApi {
	...
	public Response excute(Request request, Response response, ResponseHeader header, String method) {
		...
		//TODO Gjm 教学大纲只要存在未分配或者没用通过审核就不能发布
		...
		List<CcCourse> courseStateUnfinished = CcCourse.dao.findCourseStateUnfinished(versionId, statuses);
		if (courseStateUnfinished!=null){
