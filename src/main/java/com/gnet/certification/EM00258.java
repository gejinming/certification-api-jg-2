...
/**
 * 查看某个行政班不在某个教学班的学生列表信息接口
 * 
 * @author SY
 * @Date 2016年10月29日16:43:54
 */
@Transactional(readOnly = false)
@Service("EM00258")
public class EM00258 extends BaseApi implements IApi {
	...
	public Response excute(Request request, Response response, ResponseHeader header, String method) {
		...
		// 查询并返回结果
		Page<CcStudent> page = CcStudent.dao.pageInClassIdNotEduClassId(pageable, classId, eduClassId);
