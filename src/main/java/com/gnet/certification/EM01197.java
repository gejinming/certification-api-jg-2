 ...
 * @author Gjm
 * 
 * @date 2020年06月20日 14:26:40
 * 
 */
@Service("EM01197")
@Transactional(readOnly=true)
public class EM01197 extends BaseApi implements IApi {
	...
	public Response excute(Request request, Response response, ResponseHeader header, String method) {
		...
		Page<CcCourse> ccCoursePage = CcCourse.dao.page2(pageable, code, name, credit, planId, directionId, ignoreDirection, hierarchyName, propertyName, null);
		...
		for (CcCourse temp : ccCourseList) {
			...
			ccCourse.put("courseTeachGroupId", temp.get("teach_group_id"));
