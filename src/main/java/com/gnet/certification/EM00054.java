 ...
 */
@Service("EM00054")
public class EM00054 extends BaseApi implements IApi {
	...
	public Response excute(Request request, Response response, ResponseHeader header, String method) {
		...
		// 判断是否还有课程表在使用
		List<CcCourse> ccCourses = CcCourse.dao.findFilteredByColumnIn("hierarchy_id", idsArray);
		...
		// 返回操作是否成功
		result.put("isSuccess", CcCourseHierarchy.dao.deleteAll(idsArray, date));
